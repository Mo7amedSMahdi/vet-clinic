...
CREATE INDEX medical_treatment_medical_id_asc ON medical_treatment (medical_id ASC);
CREATE INDEX medical_treatment_treatment_id_asc ON medical_treatment (treatment_id ASC);